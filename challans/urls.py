...
urlpatterns = [
    ...
    url(r'^preview_update/(?P<challan_no>[0-9a-zA-Z-]+)/$', views.challan_preview_update, name="preview_update"),
    url(r'^weight_create/$', views.weight_create, name="weight_create"),

    url(r'^publish/(?P<challan_no>[0-9a-zA-Z-]+)/$', views.challan_update, name="update"),
